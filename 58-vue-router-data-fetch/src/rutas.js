...
import PrivadoAntes from './componentes/PrivadoAntes.vue';
...
export const routes = [
    ...
    {
        path: '/privado/:id', component: Privado, meta: {privado: true}
    },
    {
        path: '/privadoantes/:id', component: PrivadoAntes, meta: {privado: true}
    },
